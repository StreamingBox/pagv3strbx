module.exports = {
    id: "012_sync_fallback_account_passwords",
    name: "Sync active account passwords across fallback platforms",
    async up({ query }) {
        await query(`
            ...
            WHERE target.id <> source.id
              AND (target.password IS NULL OR target.password <> source.password)
              AND (
