...
function automationHttpStatus(status) {
    if (["invalid_tv_code", "tv_code_input_missing", "tv_code_submit_missing", "tv_code_submit_disabled", "account_email_missing", "email_input_missing", "continue_button_missing", "email_flow_not_advanced", "password_required", "password_input_missing", "password_submit_missing", "password_flow_not_advanced", "login_code_input_missing", "invalid_login_code", "login_code_rejected"].includes(status)) return 400;
