...
function automationHttpStatus(status) {
    if (["invalid_tv_code", "account_email_missing", "email_input_missing", "continue_button_missing", "login_code_input_missing", "invalid_login_code", "login_code_rejected"].includes(status)) return 400;
