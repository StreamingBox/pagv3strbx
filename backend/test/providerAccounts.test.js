...
const { __testing: adminProvidersTesting } = require("../src/routes/admin.providers");
...
test("renewal preserves remaining calendar days", () => {
    assert.equal(
        adminProvidersTesting.calculateRenewedExpiry("2026-09-10", "2026-09-07"),
        "2026-10-10"
    );
    assert.equal(
        adminProvidersTesting.calculateRenewedExpiry("2026-09-07", "2026-09-07"),
        "2026-10-07"
    );
    assert.equal(
        adminProvidersTesting.calculateRenewedExpiry("2026-09-01", "2026-09-07"),
        "2026-10-07"
    );
});
