            ...
            <div className="page-inner">
                ...
                <main className="main" style={{ padding: "20px 24px 40px" }}>
                    ...
                    <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
                        ...
                        {/* Status Badge */}
                        <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 16px", borderRadius: 30, background: hasToken ? "rgba(34,197,94,0.1)" : "rgba(239,68,68,0.1)", border: `1px solid ${hasToken ? "rgba(34,197,94,0.3)" : "rgba(239,68,68,0.3)"}` }}>
                            <div style={{ width: 8, height: 8, borderRadius: "50%", background: loading ? "#f59e0b" : hasToken ? "#22c55e" : "#ef4444", boxShadow: hasToken ? "0 0 8px rgba(34,197,94,0.7)" : "none" }} />
                            <span style={{ fontSize: 12, fontWeight: 700, color: hasToken ? "#22c55e" : "#ef4444" }}>
                                {loading ? "Verificando..." : hasToken ? "Conectado" : "Sin configurar"}
                            </span>
                        </div>
                    </motion.div>
                    ...
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }}
                        style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 18, marginBottom: 20 }}>
