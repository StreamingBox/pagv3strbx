...
function StatusCard({ d, onRetry }) {
    ...
    const cfg = {
        ...
        provider_timeout: { icon: "⏳", title: "La consulta tardó demasiado", color: "#f59e0b", bg: "rgba(245,158,11,0.1)", border: "rgba(245,158,11,0.3)" },
        provider_unavailable: { icon: "🌐", title: "Servicio no disponible", color: "#f59e0b", bg: "rgba(245,158,11,0.1)", border: "rgba(245,158,11,0.3)" },
        provider_auth_error: { icon: "🔐", title: "No se pudo validar el acceso", color: "#f59e0b", bg: "rgba(245,158,11,0.1)", border: "rgba(245,158,11,0.3)" },
        provider_layout_changed: { icon: "🧩", title: "Servicio actualizado", color: "#f59e0b", bg: "rgba(245,158,11,0.1)", border: "rgba(245,158,11,0.3)" },
